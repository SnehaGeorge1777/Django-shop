...
from softsecshop.models import Product, Commodity, SmartPhoneVariant, SmartPhoneModel, OperatingSystem
from softsecshop.models import Manufacturer, SmartCard


admin.site.site_header = "SoftSec Shop Administration"
...
class SmartPhoneAdmin(InvalidateProductCacheMixin, SearchProductIndexMixin, SortableAdminMixin, FrontendEditableAdminMixin,
    ...
    def render_text_index(self, instance):
        template = get_template(
            'search/indexes/softsecshop/commodity_text.txt')
