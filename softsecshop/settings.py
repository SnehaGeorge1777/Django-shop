"""
Django settings for softsecshop project.
...
ADMINS = [("SoftSec Admin", 'admin@softsec')]

# SECURITY WARNING: in production, inject the secret key through the environment
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY', '1F7D1IpRamkEd2Ex1YVwfQvqRDWZvyTnEBsPSPqDUQ08xLnRCK73mwDeCTuaKRkX')
...
STATICFILES_FINDERS = [
    ...
    'softsecshop.finders.AppDirectoriesFinder',
...
CMS_TEMPLATES = [
    ('softsecshop/pages/default.html', "Default Page"),
]
...
CMSPLUGIN_CASCADE = {
    ...
    'plugins_with_extra_render_templates': {
        'CustomSnippetPlugin': [
            ...
            ('softsecshop/catalog/manufacturer-filter.html', _("Manufacturer Filter")),
        ],
        # required to purchase real estate
        'ShopAddToCartPlugin': [
            (None, _("Default")),
            ('softsecshop/catalog/commodity-add2cart.html',
...
SHOP_CART_MODIFIERS = [
    'softsecshop.modifiers.PrimaryCartModifier',
    'shop.modifiers.taxes.CartExcludedTaxModifier',
    'softsecshop.modifiers.PostalShippingModifier',
...
SHOP_CASCADE_FORMS = {
    'CustomerForm': 'softsecshop.forms.CustomerForm',
}
